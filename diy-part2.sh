...
sed -i 's/R26.05.20/R26.05.20 (Compiled by Kisoul on 07.31.2026)/g' package/lean/default-settings/files/zzz-default-settings
...
# Fix the conflict between lede and delete small-package,includ aria2 qbittorent transmission
...
# rm -rf feeds/packages/luci/applications/luci-app-transmission
